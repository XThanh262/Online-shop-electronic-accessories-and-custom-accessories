                  ...
                  <div class="col-md-2 col-sm-2">
                     <div class="logo">
                        <a href="{{ route('user.home') }}">
                           <img src="{{ asset("asset/client/images/" . setting_website()->logo) }}" alt="PKShop">
                        </a>
                     </div>
                  </div>
         ...
         <div class="footer">
               ...
               <div class="container">
                  <div class="row">
                     ...
                     <div class="col-md-3 col-sm-6">
                        ...
                        <p>
                           Sáng Tạo Phong Cách, Bắt Đầu Từ Những Chi Tiết Nhỏ
                        </p>
                     </div>
                     <div class="col-md-3">
            ...
            {{-- <div class="copyright-info">
               <div class="container">
                  <div class="row">
                     <div class="col-md-6">
                        <p>Copyright © 2023. Designed by <a href="#">Hoang Xuan Thanh</a>. All rights reseved</p>
                     </div>
                     <div class="col-md-6">
